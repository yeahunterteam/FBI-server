...
namespace FBI.Framework.Database
{
	public sealed class DatabaseManager
	{
		...
		public bool Insert(string TableName, params object[] Values)
		{
			lock(_lock)
			{
				...
				return SQLiteConfig.Enabled ? sdatabase.Insert(TableName, sb.ToString().Remove(0, 1, FBIBase.Comma)) : mdatabase.Insert(TableName, sb.ToString().Remove(0, 1, FBIBase.Comma));
			}
		}
